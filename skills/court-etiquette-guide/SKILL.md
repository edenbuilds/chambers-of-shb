...
description: "Comprehensive guidance on Indian court etiquette, procedural protocols, and behavioral expectations for self-representing litigants, first-time lawyers, and law students"
---
...
> "Your Honour, I am [Name], appearing for [Party]. This is my first appearance in Your Honour's court."
(Judge will usually be patient with first-timers)
...
**If Judge Refuses**:
> "As Your Honour pleases. I will be ready to proceed."
(Don't argue - accept judge's decision gracefully)
...
**If No Objection**:
**AI JUDGE**: "Marked as Exhibit A-1."
...
**If Still Not Called**:
4. Mention to judge at end: "Your Honour, my case R.A. No. 123/2024 was listed but not called. May I request Your Honour's directions?"
5. Judge will either take it up OR give next date
...
**Domain:** Court Etiquette & Procedure (Indian Courts - Labour, Civil, High Court, Supreme Court)
