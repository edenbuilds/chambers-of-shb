...
description: Analyze writ petition viability - assess locus standi, alternative remedy, grounds for judicial review, appropriate writ type, and likelihood of success
version: 1.0.0
...
activation_triggers:
  - "can I file writ petition"
  - "writ viability"
  - "should I approach High Court"
  - "assess writ petition"
  - "mandamus feasible"
input_parameters:
  - user_issue: Description of government action/inaction being challenged
  - respondent: Government authority/department involved
  - relief_sought: What user wants (quash order, compel action, etc.)
  - facts: Chronological facts of the case
  - impugned_order: Details of order being challenged (if any)
output_format: Comprehensive writ viability analysis with recommendation and strategy
---
