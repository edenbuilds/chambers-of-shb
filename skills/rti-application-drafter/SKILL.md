...
description: Draft complete, legally precise RTI applications under Right to Information Act 2005 with specific information requests, proper addressing, and compliance with statutory format
version: 1.0.0
...
activation_triggers:
  ...
  - "RTI format"
  - "file RTI for"
  - "RTI to get information about"
input_parameters:
  - public_authority: Name of department/ministry/local body
  - information_sought: Specific information points (numbered list)
  - pio_address: Address of Public Information Officer (if known)
  - applicant_details: Name, address, contact of applicant
  - bpl_status: Whether applicant is Below Poverty Line
  - life_liberty: Whether information concerns life/liberty (48-hour timeline)
output_format: Complete RTI application in letter format ready to print/submit
---
